...
/** Message parameters for the {@link JarCacheUploadHandler}. */
public class JarCacheUploadMessageParameters extends MessageParameters {
    public final JarIDPathParameter jarIDPathParameter = new JarIDPathParameter();

    @Override
    public Collection<MessagePathParameter<?>> getPathParameters() {
        return Collections.singleton(jarIDPathParameter);
    }
