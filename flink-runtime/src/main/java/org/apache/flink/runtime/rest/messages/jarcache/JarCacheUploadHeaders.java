...
public class JarCacheUploadHeaders
        implements MessageHeaders<
                EmptyRequestBody, EmptyResponseBody, JarCacheUploadMessageParameters> {
    private static final JarCacheUploadHeaders INSTANCE = new JarCacheUploadHeaders();

    public static JarCacheUploadHeaders getInstance() {
        return INSTANCE;
    }
    ...
    @Override
    public JarCacheUploadMessageParameters getUnresolvedMessageParameters() {
        return new JarCacheUploadMessageParameters();
    }
